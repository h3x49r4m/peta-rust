...
impl DiagramJsGenerator {
    ...
    pub fn generate(&self) -> Result<String> {
        ...
        js.push_str(" * Generated by Peta Static Site Generator\n");
        js.push_str(" * All SVG rendering is done server-side in Rust\n");
        js.push_str(" */\n\n");

        // Placeholder for future interactive features
        js.push_str("// Diagrams are fully rendered server-side\n");
        js.push_str("// SVG is generated during build time\n");
        js.push_str("// No client-side rendering required\n\n");

        if self.config.enable_zoom || self.config.enable_pan || self.config.enable_tooltips {
            js.push_str("// Interactive features (optional)\n");
            js.push_str("document.addEventListener('DOMContentLoaded', function() {\n");
            js.push_str("  // Future interactive features can be added here\n");
            js.push_str("});\n");
        }
