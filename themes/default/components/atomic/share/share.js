(function() {
  ...
  // Initialize all share components on the page
  function initAllShares() {
    const shareComponents = document.querySelectorAll('[data-component="share"]');
    
    if (shareComponents.length === 0) {
      console.warn('No share components found');
      return;
    }
    
    shareComponents.forEach(function(shareComponent) {
      const shareToggle = shareComponent.querySelector('.share-toggle');
      const shareDropdown = shareComponent.querySelector('.share-dropdown');
      const shareOptions = shareComponent.querySelectorAll('.share-option');
      ...
      function showToast(message, isError = false) {
        ...
        Object.assign(toast.style, {
          ...
          animation: 'shareToastFadeIn 0.3s ease, shareToastFadeOut 0.3s ease 4.7s',
          opacity: '0'
        });
