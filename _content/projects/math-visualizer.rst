...
1. **2D Functions**: $y = f(x)$ with parameter exploration
2. **3D Surfaces**: $z = f(x,y)$ with rotation and zoom
3. **Parametric curves**: $(x(t), y(t), z(t))$ for complex curves
...
- **Wave interference**: $z = \sin(x)\cos(y)$
- **Gaussian distribution**: $z = e^{-(x^2+y^2)}$
- **Parametric helix**: $(\cos(t), \sin(t), t)$
- **Vector field**: $\vec{F} = (-y, x)$
